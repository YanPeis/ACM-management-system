        ...
        <el-row :gutter="20">
            ...
            <el-col>
                ...
                <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
                    ...
                    <el-table-column label="组队信息" align="center" key="deptName" prop="dept.deptName"
                  ...
                  <i class="el-icon-d-arrow-right el-icon--right"></i>更多
                                ...
                                <el-dropdown-menu slot="dropdown">
                                    ...
                                    <el-dropdown-item command="handleAuthRole" icon="el-icon-circle-check"
                                                      v-hasPermi="['system:user:edit']">分配系统权限
                                    </el-dropdown-item>
                                </el-dropdown-menu>
                            </el-dropdown>
                        </template>
        ...
        <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="组队信息" prop="deptId">
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="任职">
                            <el-select v-model="form.postIds" multiple placeholder="请选择任职">
                                <el-option
                    ...
                    <el-col :span="12">
                        <el-form-item label="系统权限">
                            <el-select v-model="form.roleIds" multiple placeholder="请选择系统权限">
                                <el-option
